...
// https://github.com/cimgui/cimgui based on imgui.h file version
// "1.92.7" 19270 from Dear ImGui https://github.com/ocornut/imgui
...
typedef struct ImGuiInputTextDeactivateData
...
struct ImGuiPlatformIO {
  ...
  void (*Platform_SetClipboardTextFn)(
  ...
  void (*Platform_SetImeDataFn)(
    ImGuiContext* ctx, ImGuiViewport* viewport,
...
typedef struct ImGuiInputTextDeactivatedState
...
typedef struct ImGuiInputEventMouseViewport
...
typedef enum {
  ...
  ImGuiDockNodeFlags_NoResizeFlagsMask_ =
    (int)ImGuiDockNodeFlags_NoResize | ImGuiDockNodeFlags_NoResizeX
...
typedef void (*ImGuiErrorCallback)(
  ImGuiContext* ctx, void* user_data, const char* msg
);
...
typedef void (*ImGuiDemoMarkerCallback)(
  const char* file, int line, const char* section
);
...
typedef ImChunkStream<ImGuiTableSettings>
  ImChunkStream_ImGuiTableSettings;
typedef ImChunkStream<ImGuiWindowSettings>
  ImChunkStream_ImGuiWindowSettings;
...
typedef ImStableVector<ImFontBaked, 32>
                                ImStableVector_ImFontBaked__32;
...
typedef ImVector<ImDrawListSharedData*>
                               ImVector_ImDrawListSharedDataPtr;
...
typedef ImVector<ImGuiDockNodeSettings>
                                       ImVector_ImGuiDockNodeSettings;
...
typedef ImVector<ImGuiListClipperRange>
  ImVector_ImGuiListClipperRange;
typedef ImVector<ImGuiMultiSelectTempData>
  ImVector_ImGuiMultiSelectTempData;
...
typedef ImVector<ImGuiSelectionRequest>
                                       ImVector_ImGuiSelectionRequest;
...
CIMGUI_API bool
  igBegin(const char* name, bool* p_open, ImGuiWindowFlags flags);
CIMGUI_API void igEnd(void);
CIMGUI_API bool igBeginChild_Str(
  const char* str_id, const ImVec2_c size,
  ImGuiChildFlags child_flags, ImGuiWindowFlags window_flags
);
CIMGUI_API bool igBeginChild_ID(
  ImGuiID id, const ImVec2_c size, ImGuiChildFlags child_flags,
...
CIMGUI_API void           igSetNextWindowPos(
            const ImVec2_c pos, ImGuiCond cond, const ImVec2_c pivot
          );
CIMGUI_API void
  igSetNextWindowSize(const ImVec2_c size, ImGuiCond cond);
CIMGUI_API void igSetNextWindowSizeConstraints(
  const ImVec2_c size_min, const ImVec2_c size_max,
...
CIMGUI_API void
  igSetWindowPos_Vec2(const ImVec2_c pos, ImGuiCond cond);
CIMGUI_API void
  igSetWindowSize_Vec2(const ImVec2_c size, ImGuiCond cond);
CIMGUI_API void
...
CIMGUI_API void igSetWindowPos_Str(
  const char* name, const ImVec2_c pos, ImGuiCond cond
);
CIMGUI_API void igSetWindowSize_Str(
  const char* name, const ImVec2_c size, ImGuiCond cond
);
...
CIMGUI_API void
  igPushFont(ImFont* font, float font_size_base_unscaled);
...
CIMGUI_API void
  igPushStyleColor_Vec4(ImGuiCol idx, const ImVec4_c col);
CIMGUI_API void igPopStyleColor(int count);
CIMGUI_API void igPushStyleVar_Float(ImGuiStyleVar idx, float val);
CIMGUI_API void
  igPushStyleVar_Vec2(ImGuiStyleVar idx, const ImVec2_c val);
...
CIMGUI_API void
  igPushID_StrStr(const char* str_id_begin, const char* str_id_end);
...
CIMGUI_API void
  igTextUnformatted(const char* text, const char* text_end);
...
CIMGUI_API void
  igTextColored(const ImVec4_c col, const char* fmt, ...);
#ifdef CIMGUI_VARGS0
CIMGUI_API void igTextColored0(const ImVec4_c col, const char* fmt);
#endif
CIMGUI_API void
  igTextColoredV(const ImVec4_c col, const char* fmt, va_list args);
...
#endif
CIMGUI_API void
  igLabelTextV(const char* label, const char* fmt, va_list args);
...
CIMGUI_API bool igInvisibleButton(
  const char* str_id, const ImVec2_c size, ImGuiButtonFlags flags
);
...
CIMGUI_API bool
  igRadioButton_IntPtr(const char* label, int* v, int v_button);
CIMGUI_API void igProgressBar(
  float fraction, const ImVec2_c size_arg, const char* overlay
);
...
CIMGUI_API void igImage(
  ImTextureRef_c tex_ref, const ImVec2_c image_size,
  const ImVec2_c uv0, const ImVec2_c uv1
);
CIMGUI_API void igImageWithBg(
  ImTextureRef_c tex_ref, const ImVec2_c image_size,
  const ImVec2_c uv0, const ImVec2_c uv1, const ImVec4_c bg_col,
  const ImVec4_c tint_col
);
CIMGUI_API bool igImageButton(
  const char* str_id, ImTextureRef_c tex_ref,
  const ImVec2_c image_size, const ImVec2_c uv0, const ImVec2_c uv1,
  const ImVec4_c bg_col, const ImVec4_c tint_col
);
...
CIMGUI_API bool igDragFloat(
  const char* label, float* v, float v_speed, float v_min,
  float v_max, const char* format, ImGuiSliderFlags flags
);
CIMGUI_API bool igDragFloat2(
  const char* label, float v[2], float v_speed, float v_min,
  float v_max, const char* format, ImGuiSliderFlags flags
);
CIMGUI_API bool igDragFloat3(
  const char* label, float v[3], float v_speed, float v_min,
  float v_max, const char* format, ImGuiSliderFlags flags
);
CIMGUI_API bool igDragFloat4(
  const char* label, float v[4], float v_speed, float v_min,
  float v_max, const char* format, ImGuiSliderFlags flags
);
...
CIMGUI_API bool igVSliderFloat(
  const char* label, const ImVec2_c size, float* v, float v_min,
  float v_max, const char* format, ImGuiSliderFlags flags
);
CIMGUI_API bool igVSliderInt(
  const char* label, const ImVec2_c size, int* v, int v_min,
  int v_max, const char* format, ImGuiSliderFlags flags
);
CIMGUI_API bool igVSliderScalar(
  const char* label, const ImVec2_c size, ImGuiDataType data_type,
...
CIMGUI_API bool igInputTextMultiline(
  const char* label, char* buf, size_t buf_size, const ImVec2_c size,
  ImGuiInputTextFlags flags, ImGuiInputTextCallback callback,
  void* user_data
);
...
CIMGUI_API bool
  igInputInt2(const char* label, int v[2], ImGuiInputTextFlags flags);
CIMGUI_API bool
  igInputInt3(const char* label, int v[3], ImGuiInputTextFlags flags);
CIMGUI_API bool
  igInputInt4(const char* label, int v[4], ImGuiInputTextFlags flags);
...
CIMGUI_API bool igColorButton(
  const char* desc_id, const ImVec4_c col, ImGuiColorEditFlags flags,
  const ImVec2_c size
);
CIMGUI_API void igSetColorEditOptions(ImGuiColorEditFlags flags);
CIMGUI_API bool igTreeNode_Str(const char* label);
CIMGUI_API bool
  igTreeNode_StrStr(const char* str_id, const char* fmt, ...);
#ifdef CIMGUI_VARGS0
CIMGUI_API bool
  igTreeNode_StrStr0(const char* str_id, const char* fmt);
#endif
CIMGUI_API bool
  igTreeNode_Ptr(const void* ptr_id, const char* fmt, ...);
#ifdef CIMGUI_VARGS0
CIMGUI_API bool igTreeNode_Ptr0(const void* ptr_id, const char* fmt);
#endif
CIMGUI_API bool
  igTreeNodeV_Str(const char* str_id, const char* fmt, va_list args);
CIMGUI_API bool
  igTreeNodeV_Ptr(const void* ptr_id, const char* fmt, va_list args);
CIMGUI_API bool
  igTreeNodeEx_Str(const char* label, ImGuiTreeNodeFlags flags);
CIMGUI_API bool igTreeNodeEx_StrStr(
  const char* str_id, ImGuiTreeNodeFlags flags, const char* fmt, ...
);
#ifdef CIMGUI_VARGS0
CIMGUI_API bool igTreeNodeEx_StrStr0(
  const char* str_id, ImGuiTreeNodeFlags flags, const char* fmt
);
#endif
...
#ifdef CIMGUI_VARGS0
CIMGUI_API bool igTreeNodeEx_Ptr0(
  const void* ptr_id, ImGuiTreeNodeFlags flags, const char* fmt
);
#endif
...
CIMGUI_API ImGuiMultiSelectIO* igBeginMultiSelect(
...
CIMGUI_API bool
  igBeginListBox(const char* label, const ImVec2_c size);
...
CIMGUI_API void igPlotLines_FloatPtr(
  ...
  float scale_max, ImVec2_c graph_size, int stride
);
...
CIMGUI_API bool
  igBeginPopup(const char* str_id, ImGuiWindowFlags flags);
CIMGUI_API bool igBeginPopupModal(
  const char* name, bool* p_open, ImGuiWindowFlags flags
);
CIMGUI_API void igEndPopup(void);
CIMGUI_API void
  igOpenPopup_Str(const char* str_id, ImGuiPopupFlags popup_flags);
CIMGUI_API void
  igOpenPopup_ID(ImGuiID id, ImGuiPopupFlags popup_flags);
...
CIMGUI_API bool
  igIsPopupOpen_Str(const char* str_id, ImGuiPopupFlags flags);
CIMGUI_API bool igBeginTable(
  const char* str_id, int columns, ImGuiTableFlags flags,
  const ImVec2_c outer_size, float inner_width
);
...
CIMGUI_API bool
  igBeginTabBar(const char* str_id, ImGuiTabBarFlags flags);
...
CIMGUI_API bool
  igTabItemButton(const char* label, ImGuiTabItemFlags flags);
CIMGUI_API void
  igSetTabItemClosed(const char* tab_or_docked_window_label);
CIMGUI_API ImGuiID igDockSpace(
  ImGuiID dockspace_id, const ImVec2_c size, ImGuiDockNodeFlags flags,
  const ImGuiWindowClass* window_class
);
CIMGUI_API ImGuiID igDockSpaceOverViewport(
  ImGuiID dockspace_id, const ImGuiViewport* viewport,
  ImGuiDockNodeFlags flags, const ImGuiWindowClass* window_class
);
CIMGUI_API void
  igSetNextWindowDockID(ImGuiID dock_id, ImGuiCond cond);
CIMGUI_API void
  igSetNextWindowClass(const ImGuiWindowClass* window_class);
...
CIMGUI_API void
  igLogToFile(int auto_open_depth, const char* filename);
...
CIMGUI_API void                igPushClipRect(
                 const ImVec2_c clip_rect_min, const ImVec2_c clip_rect_max,
...
CIMGUI_API ImDrawList*
  igGetBackgroundDrawList(ImGuiViewport* viewport);
CIMGUI_API ImDrawList*
...
CIMGUI_API bool igIsRectVisible_Vec2(
  const ImVec2_c rect_min, const ImVec2_c rect_max
);
...
CIMGUI_API ImVec2_c      igCalcTextSize(
...
CIMGUI_API int
  igGetKeyPressedAmount(ImGuiKey key, float repeat_delay, float rate);
CIMGUI_API const char* igGetKeyName(ImGuiKey key);
CIMGUI_API void
  igSetNextFrameWantCaptureKeyboard(bool want_capture_keyboard);
CIMGUI_API bool
  igShortcut_Nil(ImGuiKeyChord key_chord, ImGuiInputFlags flags);
CIMGUI_API void igSetNextItemShortcut(
...
CIMGUI_API bool
  igIsMouseClicked_Bool(ImGuiMouseButton button, bool repeat);
...
CIMGUI_API bool
  igIsMouseReleasedWithDelay(ImGuiMouseButton button, float delay);
CIMGUI_API int  igGetMouseClickedCount(ImGuiMouseButton button);
CIMGUI_API bool igIsMouseHoveringRect(
  const ImVec2_c r_min, const ImVec2_c r_max, bool clip
);
...
CIMGUI_API bool
  igIsMouseDragging(ImGuiMouseButton button, float lock_threshold);
CIMGUI_API ImVec2_c
  igGetMouseDragDelta(ImGuiMouseButton button, float lock_threshold);
...
CIMGUI_API void
  igLoadIniSettingsFromMemory(const char* ini_data, size_t ini_size);
CIMGUI_API void igSaveIniSettingsToDisk(const char* ini_filename);
CIMGUI_API const char*
                igSaveIniSettingsToMemory(size_t* out_ini_size);
...
CIMGUI_API ImGuiViewport*
  igFindViewportByPlatformHandle(void* platform_handle);
CIMGUI_API ImGuiTableSortSpecs*
  ImGuiTableSortSpecs_ImGuiTableSortSpecs(void);
CIMGUI_API void
  ImGuiTableSortSpecs_destroy(ImGuiTableSortSpecs* self);
...
CIMGUI_API void
  ImGuiStyle_ScaleAllSizes(ImGuiStyle* self, float scale_factor);
CIMGUI_API void
  ImGuiIO_AddKeyEvent(ImGuiIO* self, ImGuiKey key, bool down);
CIMGUI_API void ImGuiIO_AddKeyAnalogEvent(
  ImGuiIO* self, ImGuiKey key, bool down, float v
);
CIMGUI_API void
  ImGuiIO_AddMousePosEvent(ImGuiIO* self, float x, float y);
CIMGUI_API void
  ImGuiIO_AddMouseButtonEvent(ImGuiIO* self, int button, bool down);
CIMGUI_API void ImGuiIO_AddMouseWheelEvent(
  ImGuiIO* self, float wheel_x, float wheel_y
);
CIMGUI_API void
  ImGuiIO_AddMouseSourceEvent(ImGuiIO* self, ImGuiMouseSource source);
CIMGUI_API void
  ImGuiIO_AddMouseViewportEvent(ImGuiIO* self, ImGuiID id);
CIMGUI_API void ImGuiIO_AddFocusEvent(ImGuiIO* self, bool focused);
CIMGUI_API void
  ImGuiIO_AddInputCharacter(ImGuiIO* self, unsigned int c);
CIMGUI_API void
  ImGuiIO_AddInputCharacterUTF16(ImGuiIO* self, ImWchar16 c);
CIMGUI_API void
  ImGuiIO_AddInputCharactersUTF8(ImGuiIO* self, const char* str);
...
CIMGUI_API void
  ImGuiIO_SetAppAcceptingEvents(ImGuiIO* self, bool accepting_events);
...
CIMGUI_API void ImGuiInputTextCallbackData_SetSelection(
  ImGuiInputTextCallbackData* self, int s, int e
);
...
CIMGUI_API bool
  ImGuiPayload_IsDataType(ImGuiPayload* self, const char* type);
CIMGUI_API bool ImGuiPayload_IsPreview(ImGuiPayload* self);
CIMGUI_API bool ImGuiPayload_IsDelivery(ImGuiPayload* self);
CIMGUI_API ImGuiOnceUponAFrame*
  ImGuiOnceUponAFrame_ImGuiOnceUponAFrame(void);
CIMGUI_API void
  ImGuiOnceUponAFrame_destroy(ImGuiOnceUponAFrame* self);
...
CIMGUI_API bool ImGuiTextFilter_Draw(
  ImGuiTextFilter* self, const char* label, float width
);
CIMGUI_API bool ImGuiTextFilter_PassFilter(
  ImGuiTextFilter* self, const char* text, const char* text_end
);
...
CIMGUI_API ImGuiTextRange*
  ImGuiTextRange_ImGuiTextRange_Str(const char* _b, const char* _e);
CIMGUI_API bool ImGuiTextRange_empty(ImGuiTextRange* self);
CIMGUI_API void ImGuiTextRange_split(
  ImGuiTextRange* self, char separator, ImVector_ImGuiTextRange* out
);
...
CIMGUI_API void
  ImGuiTextBuffer_resize(ImGuiTextBuffer* self, int size);
CIMGUI_API void
  ImGuiTextBuffer_reserve(ImGuiTextBuffer* self, int capacity);
CIMGUI_API const char* ImGuiTextBuffer_c_str(ImGuiTextBuffer* self);
CIMGUI_API void        ImGuiTextBuffer_append(
         ImGuiTextBuffer* self, const char* str, const char* str_end
       );
CIMGUI_API void ImGuiTextBuffer_appendfv(
  ImGuiTextBuffer* self, const char* fmt, va_list args
);
CIMGUI_API ImGuiStoragePair*
  ImGuiStoragePair_ImGuiStoragePair_Int(ImGuiID _key, int _val);
CIMGUI_API void ImGuiStoragePair_destroy(ImGuiStoragePair* self);
CIMGUI_API ImGuiStoragePair*
  ImGuiStoragePair_ImGuiStoragePair_Float(ImGuiID _key, float _val);
CIMGUI_API ImGuiStoragePair*
  ImGuiStoragePair_ImGuiStoragePair_Ptr(ImGuiID _key, void* _val);
CIMGUI_API void ImGuiStorage_Clear(ImGuiStorage* self);
CIMGUI_API int  ImGuiStorage_GetInt(
   ImGuiStorage* self, ImGuiID key, int default_val
 );
CIMGUI_API void
  ImGuiStorage_SetInt(ImGuiStorage* self, ImGuiID key, int val);
CIMGUI_API bool ImGuiStorage_GetBool(
  ImGuiStorage* self, ImGuiID key, bool default_val
);
CIMGUI_API void
  ImGuiStorage_SetBool(ImGuiStorage* self, ImGuiID key, bool val);
CIMGUI_API float ImGuiStorage_GetFloat(
  ImGuiStorage* self, ImGuiID key, float default_val
);
CIMGUI_API void
  ImGuiStorage_SetFloat(ImGuiStorage* self, ImGuiID key, float val);
CIMGUI_API void*
  ImGuiStorage_GetVoidPtr(ImGuiStorage* self, ImGuiID key);
CIMGUI_API void
  ImGuiStorage_SetVoidPtr(ImGuiStorage* self, ImGuiID key, void* val);
...
CIMGUI_API void ImGuiListClipper_Begin(
  ImGuiListClipper* self, int items_count, float items_height
);
...
CIMGUI_API void ImGuiListClipper_IncludeItemByIndex(
  ImGuiListClipper* self, int item_index
);
CIMGUI_API void ImGuiListClipper_IncludeItemsByIndex(
  ImGuiListClipper* self, int item_begin, int item_end
);
...
CIMGUI_API void
  ImColor_SetHSV(ImColor* self, float h, float s, float v, float a);
...
CIMGUI_API void ImGuiSelectionBasicStorage_ApplyRequests(
  ImGuiSelectionBasicStorage* self, ImGuiMultiSelectIO* ms_io
);
CIMGUI_API bool ImGuiSelectionBasicStorage_Contains(
  ImGuiSelectionBasicStorage* self, ImGuiID id
);
CIMGUI_API void
  ImGuiSelectionBasicStorage_Clear(ImGuiSelectionBasicStorage* self);
CIMGUI_API void ImGuiSelectionBasicStorage_Swap(
  ImGuiSelectionBasicStorage* self, ImGuiSelectionBasicStorage* r
);
CIMGUI_API void ImGuiSelectionBasicStorage_SetItemSelected(
  ImGuiSelectionBasicStorage* self, ImGuiID id, bool selected
);
CIMGUI_API bool ImGuiSelectionBasicStorage_GetNextSelectedItem(
  ImGuiSelectionBasicStorage* self, void** opaque_it, ImGuiID* out_id
);
...
CIMGUI_API void ImGuiSelectionExternalStorage_ApplyRequests(
  ImGuiSelectionExternalStorage* self, ImGuiMultiSelectIO* ms_io
);
...
CIMGUI_API ImDrawListSplitter*
                ImDrawListSplitter_ImDrawListSplitter(void);
...
CIMGUI_API void
  ImDrawListSplitter_ClearFreeMemory(ImDrawListSplitter* self);
...
CIMGUI_API void ImDrawList_PushClipRect(
  ImDrawList* self, const ImVec2_c clip_rect_min,
  const ImVec2_c clip_rect_max, bool intersect_with_current_clip_rect
);
CIMGUI_API void ImDrawList_PushClipRectFullScreen(ImDrawList* self);
CIMGUI_API void ImDrawList_PopClipRect(ImDrawList* self);
CIMGUI_API void
  ImDrawList_PushTexture(ImDrawList* self, ImTextureRef_c tex_ref);
...
CIMGUI_API void     ImDrawList_AddLine(
      ImDrawList* self, const ImVec2_c p1, const ImVec2_c p2, ImU32 col,
      float thickness
    );
CIMGUI_API void ImDrawList_AddRect(
  ImDrawList* self, const ImVec2_c p_min, const ImVec2_c p_max,
...
CIMGUI_API void ImDrawList_AddQuad(
  ImDrawList* self, const ImVec2_c p1, const ImVec2_c p2,
  const ImVec2_c p3, const ImVec2_c p4, ImU32 col, float thickness
);
CIMGUI_API void ImDrawList_AddQuadFilled(
  ImDrawList* self, const ImVec2_c p1, const ImVec2_c p2,
  const ImVec2_c p3, const ImVec2_c p4, ImU32 col
);
CIMGUI_API void ImDrawList_AddTriangle(
  ImDrawList* self, const ImVec2_c p1, const ImVec2_c p2,
  const ImVec2_c p3, ImU32 col, float thickness
);
CIMGUI_API void ImDrawList_AddTriangleFilled(
  ImDrawList* self, const ImVec2_c p1, const ImVec2_c p2,
  const ImVec2_c p3, ImU32 col
);
CIMGUI_API void ImDrawList_AddCircle(
  ImDrawList* self, const ImVec2_c center, float radius, ImU32 col,
...
CIMGUI_API void ImDrawList_AddEllipse(
  ImDrawList* self, const ImVec2_c center, const ImVec2_c radius,
  ImU32 col, float rot, int num_segments, float thickness
);
...
CIMGUI_API void ImDrawList_AddText_Vec2(
  ImDrawList* self, const ImVec2_c pos, ImU32 col,
  const char* text_begin, const char* text_end
);
CIMGUI_API void ImDrawList_AddText_FontPtr(
  ImDrawList* self, ImFont* font, float font_size, const ImVec2_c pos,
...
CIMGUI_API void ImDrawList_AddBezierQuadratic(
  ImDrawList* self, const ImVec2_c p1, const ImVec2_c p2,
  const ImVec2_c p3, ImU32 col, float thickness, int num_segments
);
CIMGUI_API void ImDrawList_AddPolyline(
  ImDrawList* self, const ImVec2_c* points, int num_points, ImU32 col,
...
CIMGUI_API void ImDrawList_AddImage(
  ImDrawList* self, ImTextureRef_c tex_ref, const ImVec2_c p_min,
  const ImVec2_c p_max, const ImVec2_c uv_min, const ImVec2_c uv_max,
  ImU32 col
);
CIMGUI_API void ImDrawList_AddImageQuad(
  ImDrawList* self, ImTextureRef_c tex_ref, const ImVec2_c p1,
  const ImVec2_c p2, const ImVec2_c p3, const ImVec2_c p4,
  const ImVec2_c uv1, const ImVec2_c uv2, const ImVec2_c uv3,
  const ImVec2_c uv4, ImU32 col
);
...
CIMGUI_API void
  ImDrawList_PathLineTo(ImDrawList* self, const ImVec2_c pos);
CIMGUI_API void ImDrawList_PathLineToMergeDuplicate(
  ImDrawList* self, const ImVec2_c pos
);
CIMGUI_API void
  ImDrawList_PathFillConvex(ImDrawList* self, ImU32 col);
CIMGUI_API void
  ImDrawList_PathFillConcave(ImDrawList* self, ImU32 col);
CIMGUI_API void ImDrawList_PathStroke(
  ImDrawList* self, ImU32 col, ImDrawFlags flags, float thickness
);
CIMGUI_API void ImDrawList_PathArcTo(
  ImDrawList* self, const ImVec2_c center, float radius, float a_min,
  float a_max, int num_segments
);
CIMGUI_API void ImDrawList_PathArcToFast(
  ImDrawList* self, const ImVec2_c center, float radius,
...
CIMGUI_API void ImDrawList_PathBezierCubicCurveTo(
  ImDrawList* self, const ImVec2_c p2, const ImVec2_c p3,
  const ImVec2_c p4, int num_segments
);
...
CIMGUI_API void ImDrawList_PathRect(
  ImDrawList* self, const ImVec2_c rect_min, const ImVec2_c rect_max,
  float rounding, ImDrawFlags flags
);
CIMGUI_API void ImDrawList_AddCallback(
  ImDrawList* self, ImDrawCallback callback, void* userdata,
...
CIMGUI_API void
  ImDrawList_ChannelsSetCurrent(ImDrawList* self, int n);
...
CIMGUI_API void ImDrawList_PrimRect(
  ImDrawList* self, const ImVec2_c a, const ImVec2_c b, ImU32 col
);
CIMGUI_API void ImDrawList_PrimRectUV(
  ImDrawList* self, const ImVec2_c a, const ImVec2_c b,
  const ImVec2_c uv_a, const ImVec2_c uv_b, ImU32 col
);
CIMGUI_API void ImDrawList_PrimQuadUV(
  ImDrawList* self, const ImVec2_c a, const ImVec2_c b,
  const ImVec2_c c, const ImVec2_c d, const ImVec2_c uv_a,
  const ImVec2_c uv_b, const ImVec2_c uv_c, const ImVec2_c uv_d,
  ImU32 col
);
CIMGUI_API void ImDrawList_PrimWriteVtx(
  ImDrawList* self, const ImVec2_c pos, const ImVec2_c uv, ImU32 col
);
CIMGUI_API void
  ImDrawList_PrimWriteIdx(ImDrawList* self, ImDrawIdx idx);
CIMGUI_API void ImDrawList_PrimVtx(
  ImDrawList* self, const ImVec2_c pos, const ImVec2_c uv, ImU32 col
);
CIMGUI_API void ImDrawList__SetDrawListSharedData(
  ImDrawList* self, ImDrawListSharedData* data
);
...
CIMGUI_API void
  ImDrawList__SetTexture(ImDrawList* self, ImTextureRef_c tex_ref);
...
CIMGUI_API void
  ImFontGlyphRangesBuilder_Clear(ImFontGlyphRangesBuilder* self);
...
CIMGUI_API ImFont* ImFontAtlas_AddFontDefaultVector(
  ImFontAtlas* self, const ImFontConfig* font_cfg
);
CIMGUI_API ImFont* ImFontAtlas_AddFontDefaultBitmap(
  ImFontAtlas* self, const ImFontConfig* font_cfg
);
CIMGUI_API ImFont* ImFontAtlas_AddFontFromFileTTF(
  ImFontAtlas* self, const char* filename, float size_pixels,
  const ImFontConfig* font_cfg, const ImWchar* glyph_ranges
);
CIMGUI_API ImFont* ImFontAtlas_AddFontFromMemoryTTF(
  ImFontAtlas* self, void* font_data, int font_data_size,
...
CIMGUI_API void
  ImFontAtlas_RemoveFont(ImFontAtlas* self, ImFont* font);
CIMGUI_API void ImFontAtlas_Clear(ImFontAtlas* self);
CIMGUI_API void ImFontAtlas_CompactCache(ImFontAtlas* self);
CIMGUI_API void ImFontAtlas_SetFontLoader(
  ImFontAtlas* self, const ImFontLoader* font_loader
);
...
CIMGUI_API const ImWchar*
  ImFontAtlas_GetGlyphRangesDefault(ImFontAtlas* self);
CIMGUI_API ImFontAtlasRectId ImFontAtlas_AddCustomRect(
  ImFontAtlas* self, int width, int height, ImFontAtlasRect* out_r
);
CIMGUI_API void ImFontAtlas_RemoveCustomRect(
  ImFontAtlas* self, ImFontAtlasRectId id
);
CIMGUI_API bool ImFontAtlas_GetCustomRect(
  ImFontAtlas* self, ImFontAtlasRectId id, ImFontAtlasRect* out_r
);
...
CIMGUI_API ImFontGlyph*
  ImFontBaked_FindGlyph(ImFontBaked* self, ImWchar c);
CIMGUI_API ImFontGlyph*
  ImFontBaked_FindGlyphNoFallback(ImFontBaked* self, ImWchar c);
CIMGUI_API float
  ImFontBaked_GetCharAdvance(ImFontBaked* self, ImWchar c);
CIMGUI_API bool
  ImFontBaked_IsGlyphLoaded(ImFontBaked* self, ImWchar c);
...
CIMGUI_API ImFontBaked*
  ImFont_GetFontBaked(ImFont* self, float font_size, float density);
CIMGUI_API ImVec2_c ImFont_CalcTextSizeA(
...
CIMGUI_API const char* ImFont_CalcWordWrapPosition(
  ImFont* self, float size, const char* text, const char* text_end,
  float wrap_width
);
CIMGUI_API void ImFont_RenderChar(
  ImFont* self, ImDrawList* draw_list, float size, const ImVec2_c pos,
  ImU32 col, ImWchar c, const ImVec4* cpu_fine_clip
);
CIMGUI_API void ImFont_RenderText(
  ImFont* self, ImDrawList* draw_list, float size, const ImVec2_c pos,
  ImU32 col, const ImVec4_c clip_rect, const char* text_begin,
  const char* text_end, float wrap_width, ImDrawTextFlags flags
);
CIMGUI_API void ImFont_ClearOutputData(ImFont* self);
CIMGUI_API void ImFont_AddRemapChar(
  ImFont* self, ImWchar from_codepoint, ImWchar to_codepoint
);
...
CIMGUI_API const char*
  ImGuiViewport_GetDebugName(ImGuiViewport* self);
...
CIMGUI_API void
  ImGuiPlatformIO_ClearPlatformHandlers(ImGuiPlatformIO* self);
CIMGUI_API void
  ImGuiPlatformIO_ClearRendererHandlers(ImGuiPlatformIO* self);
CIMGUI_API ImGuiPlatformMonitor*
  ImGuiPlatformMonitor_ImGuiPlatformMonitor(void);
CIMGUI_API void
  ImGuiPlatformMonitor_destroy(ImGuiPlatformMonitor* self);
CIMGUI_API ImGuiPlatformImeData*
  ImGuiPlatformImeData_ImGuiPlatformImeData(void);
CIMGUI_API void
  ImGuiPlatformImeData_destroy(ImGuiPlatformImeData* self);
CIMGUI_API ImGuiID
  igImHashData(const void* data, size_t data_size, ImGuiID seed);
CIMGUI_API ImGuiID
  igImHashStr(const char* data, size_t data_size, ImGuiID seed);
CIMGUI_API const char*
                igImHashSkipUncontributingPrefix(const char* label);
...
CIMGUI_API int
  igImStrnicmp(const char* str1, const char* str2, size_t count);
...
CIMGUI_API char*
  igImStrdupcpy(char* dst, size_t* p_dst_size, const char* str);
CIMGUI_API const char*
  igImStrchrRange(const char* str_begin, const char* str_end, char c);
CIMGUI_API const char*
  igImStreolRange(const char* str, const char* str_end);
...
CIMGUI_API const char*
  igImStrbol(const char* buf_mid_line, const char* buf_begin);
...
CIMGUI_API int
  igImFormatString(char* buf, size_t buf_size, const char* fmt, ...);
#ifdef CIMGUI_VARGS0
CIMGUI_API int
  igImFormatString0(char* buf, size_t buf_size, const char* fmt);
#endif
...
#ifdef CIMGUI_VARGS0
CIMGUI_API void igImFormatStringToTempBuffer0(
  const char** out_buf, const char** out_buf_end, const char* fmt
);
#endif
...
CIMGUI_API int
  igImParseFormatPrecision(const char* format, int default_value);
...
CIMGUI_API const char* igImTextFindPreviousUtf8Codepoint(
  const char* in_text_start, const char* in_p
);
CIMGUI_API const char* igImTextFindValidUtf8CodepointEnd(
  const char* in_text_start, const char* in_text_end, const char* in_p
);
CIMGUI_API int
  igImTextCountLines(const char* in_text, const char* in_text_end);
...
CIMGUI_API ImVec2_c
  igImClamp(const ImVec2_c v, const ImVec2_c mn, const ImVec2_c mx);
CIMGUI_API ImVec2_c
  igImLerp_Vec2Float(const ImVec2_c a, const ImVec2_c b, float t);
CIMGUI_API ImVec2_c igImLerp_Vec2Vec2(
  const ImVec2_c a, const ImVec2_c b, const ImVec2_c t
);
CIMGUI_API ImVec4_c
  igImLerp_Vec4(const ImVec4_c a, const ImVec4_c b, float t);
...
CIMGUI_API ImVec2_c
  igImRotate(const ImVec2_c v, float cos_a, float sin_a);
CIMGUI_API float
  igImLinearSweep(float current, float target, float speed);
CIMGUI_API float igImLinearRemapClamp(
  float s0, float s1, float d0, float d1, float x
);
...
CIMGUI_API float
  igImExponentialMovingAverage(float avg, float sample, int n);
CIMGUI_API ImVec2_c igImBezierCubicCalc(
  const ImVec2_c p1, const ImVec2_c p2, const ImVec2_c p3,
  const ImVec2_c p4, float t
);
CIMGUI_API ImVec2_c igImBezierCubicClosestPoint(
  const ImVec2_c p1, const ImVec2_c p2, const ImVec2_c p3,
  const ImVec2_c p4, const ImVec2_c p, int num_segments
);
CIMGUI_API ImVec2_c igImBezierCubicClosestPointCasteljau(
  const ImVec2_c p1, const ImVec2_c p2, const ImVec2_c p3,
  const ImVec2_c p4, const ImVec2_c p, float tess_tol
);
CIMGUI_API ImVec2_c igImBezierQuadraticCalc(
  const ImVec2_c p1, const ImVec2_c p2, const ImVec2_c p3, float t
);
CIMGUI_API ImVec2_c igImLineClosestPoint(
  const ImVec2_c a, const ImVec2_c b, const ImVec2_c p
);
CIMGUI_API bool igImTriangleContainsPoint(
  const ImVec2_c a, const ImVec2_c b, const ImVec2_c c,
  const ImVec2_c p
);
CIMGUI_API ImVec2_c igImTriangleClosestPoint(
  const ImVec2_c a, const ImVec2_c b, const ImVec2_c c,
  const ImVec2_c p
);
CIMGUI_API void igImTriangleBarycentricCoords(
  const ImVec2_c a, const ImVec2_c b, const ImVec2_c c,
  const ImVec2_c p, float* out_u, float* out_v, float* out_w
);
CIMGUI_API float igImTriangleArea(
  const ImVec2_c a, const ImVec2_c b, const ImVec2_c c
);
CIMGUI_API bool igImTriangleIsClockwise(
  const ImVec2_c a, const ImVec2_c b, const ImVec2_c c
);
...
CIMGUI_API ImRect*
  ImRect_ImRect_Vec2(const ImVec2_c min, const ImVec2_c max);
...
CIMGUI_API bool ImRect_ContainsWithPad(
  ImRect* self, const ImVec2_c p, const ImVec2_c pad
);
...
CIMGUI_API void
  ImRect_Expand_Vec2(ImRect* self, const ImVec2_c amount);
...
CIMGUI_API const char* ImGuiTextIndex_get_line_begin(
  ImGuiTextIndex* self, const char* base, int n
);
CIMGUI_API const char* ImGuiTextIndex_get_line_end(
  ImGuiTextIndex* self, const char* base, int n
);
CIMGUI_API void ImGuiTextIndex_append(
  ImGuiTextIndex* self, const char* base, int old_size, int new_size
);
CIMGUI_API ImGuiStoragePair* igImLowerBound(
...
CIMGUI_API void
  ImDrawListSharedData_destroy(ImDrawListSharedData* self);
CIMGUI_API void ImDrawListSharedData_SetCircleTessellationMaxError(
  ImDrawListSharedData* self, float max_error
);
CIMGUI_API ImDrawDataBuilder*
                ImDrawDataBuilder_ImDrawDataBuilder(void);
CIMGUI_API void ImDrawDataBuilder_destroy(ImDrawDataBuilder* self);
CIMGUI_API void*
  ImGuiStyleVarInfo_GetVarPtr(ImGuiStyleVarInfo* self, void* parent);
CIMGUI_API ImGuiStyleMod*
  ImGuiStyleMod_ImGuiStyleMod_Int(ImGuiStyleVar idx, int v);
CIMGUI_API void ImGuiStyleMod_destroy(ImGuiStyleMod* self);
CIMGUI_API ImGuiStyleMod*
  ImGuiStyleMod_ImGuiStyleMod_Float(ImGuiStyleVar idx, float v);
CIMGUI_API ImGuiStyleMod*
  ImGuiStyleMod_ImGuiStyleMod_Vec2(ImGuiStyleVar idx, ImVec2_c v);
CIMGUI_API ImGuiComboPreviewData*
  ImGuiComboPreviewData_ImGuiComboPreviewData(void);
CIMGUI_API void
  ImGuiComboPreviewData_destroy(ImGuiComboPreviewData* self);
...
CIMGUI_API void ImGuiMenuColumns_Update(
  ImGuiMenuColumns* self, float spacing, bool window_reappearing
);
CIMGUI_API float ImGuiMenuColumns_DeclColumns(
  ImGuiMenuColumns* self, float w_icon, float w_label,
  float w_shortcut, float w_mark
);
CIMGUI_API void ImGuiMenuColumns_CalcNextTotalWidth(
  ImGuiMenuColumns* self, bool update_offsets
);
...
CIMGUI_API ImGuiInputTextState*
  ImGuiInputTextState_ImGuiInputTextState(void);
CIMGUI_API void
  ImGuiInputTextState_destroy(ImGuiInputTextState* self);
CIMGUI_API void
  ImGuiInputTextState_ClearText(ImGuiInputTextState* self);
CIMGUI_API void
  ImGuiInputTextState_ClearFreeMemory(ImGuiInputTextState* self);
CIMGUI_API void ImGuiInputTextState_OnKeyPressed(
  ImGuiInputTextState* self, int key
);
CIMGUI_API void ImGuiInputTextState_OnCharPressed(
  ImGuiInputTextState* self, unsigned int c
);
CIMGUI_API float
  ImGuiInputTextState_GetPreferredOffsetX(ImGuiInputTextState* self);
CIMGUI_API const char*
  ImGuiInputTextState_GetText(ImGuiInputTextState* self);
CIMGUI_API void
  ImGuiInputTextState_CursorAnimReset(ImGuiInputTextState* self);
CIMGUI_API void
  ImGuiInputTextState_CursorClamp(ImGuiInputTextState* self);
CIMGUI_API bool
  ImGuiInputTextState_HasSelection(ImGuiInputTextState* self);
CIMGUI_API void
  ImGuiInputTextState_ClearSelection(ImGuiInputTextState* self);
CIMGUI_API int
  ImGuiInputTextState_GetCursorPos(ImGuiInputTextState* self);
CIMGUI_API int
  ImGuiInputTextState_GetSelectionStart(ImGuiInputTextState* self);
CIMGUI_API int
  ImGuiInputTextState_GetSelectionEnd(ImGuiInputTextState* self);
CIMGUI_API void ImGuiInputTextState_SetSelection(
  ImGuiInputTextState* self, int start, int end
);
CIMGUI_API void
  ImGuiInputTextState_SelectAll(ImGuiInputTextState* self);
...
CIMGUI_API ImGuiNextWindowData*
  ImGuiNextWindowData_ImGuiNextWindowData(void);
CIMGUI_API void
  ImGuiNextWindowData_destroy(ImGuiNextWindowData* self);
CIMGUI_API void
  ImGuiNextWindowData_ClearFlags(ImGuiNextWindowData* self);
CIMGUI_API ImGuiNextItemData*
                ImGuiNextItemData_ImGuiNextItemData(void);
...
CIMGUI_API ImGuiLastItemData*
                ImGuiLastItemData_ImGuiLastItemData(void);
...
CIMGUI_API void
  ImGuiErrorRecoveryState_destroy(ImGuiErrorRecoveryState* self);
CIMGUI_API ImGuiPtrOrIndex*
...
CIMGUI_API ImGuiKeyRoutingData*
  ImGuiKeyRoutingData_ImGuiKeyRoutingData(void);
CIMGUI_API void
  ImGuiKeyRoutingData_destroy(ImGuiKeyRoutingData* self);
CIMGUI_API ImGuiKeyRoutingTable*
  ImGuiKeyRoutingTable_ImGuiKeyRoutingTable(void);
CIMGUI_API void
  ImGuiKeyRoutingTable_destroy(ImGuiKeyRoutingTable* self);
CIMGUI_API void
  ImGuiKeyRoutingTable_Clear(ImGuiKeyRoutingTable* self);
CIMGUI_API ImGuiKeyOwnerData*
                ImGuiKeyOwnerData_ImGuiKeyOwnerData(void);
...
CIMGUI_API void
  ImGuiListClipperData_destroy(ImGuiListClipperData* self);
CIMGUI_API void ImGuiListClipperData_Reset(
  ImGuiListClipperData* self, ImGuiListClipper* clipper
);
...
CIMGUI_API void
  ImGuiTypingSelectState_destroy(ImGuiTypingSelectState* self);
CIMGUI_API void
  ImGuiTypingSelectState_Clear(ImGuiTypingSelectState* self);
CIMGUI_API ImGuiOldColumnData*
                ImGuiOldColumnData_ImGuiOldColumnData(void);
...
CIMGUI_API ImGuiBoxSelectState*
  ImGuiBoxSelectState_ImGuiBoxSelectState(void);
CIMGUI_API void
  ImGuiBoxSelectState_destroy(ImGuiBoxSelectState* self);
CIMGUI_API ImGuiMultiSelectTempData*
  ImGuiMultiSelectTempData_ImGuiMultiSelectTempData(void);
CIMGUI_API void
  ImGuiMultiSelectTempData_destroy(ImGuiMultiSelectTempData* self);
CIMGUI_API void
  ImGuiMultiSelectTempData_Clear(ImGuiMultiSelectTempData* self);
CIMGUI_API void
  ImGuiMultiSelectTempData_ClearIO(ImGuiMultiSelectTempData* self);
CIMGUI_API ImGuiMultiSelectState*
  ImGuiMultiSelectState_ImGuiMultiSelectState(void);
CIMGUI_API void
  ImGuiMultiSelectState_destroy(ImGuiMultiSelectState* self);
...
CIMGUI_API void     ImGuiDockNode_SetLocalFlags(
      ImGuiDockNode* self, ImGuiDockNodeFlags flags
    );
...
CIMGUI_API void
  ImGuiViewportP_ClearRequestFlags(ImGuiViewportP* self);
CIMGUI_API ImVec2_c ImGuiViewportP_CalcWorkRectPos(
  ImGuiViewportP* self, const ImVec2_c inset_min
);
CIMGUI_API ImVec2_c ImGuiViewportP_CalcWorkRectSize(
  ImGuiViewportP* self, const ImVec2_c inset_min,
...
CIMGUI_API ImRect_c
  ImGuiViewportP_GetBuildWorkRect(ImGuiViewportP* self);
CIMGUI_API ImGuiWindowSettings*
  ImGuiWindowSettings_ImGuiWindowSettings(void);
CIMGUI_API void
  ImGuiWindowSettings_destroy(ImGuiWindowSettings* self);
CIMGUI_API char*
  ImGuiWindowSettings_GetName(ImGuiWindowSettings* self);
CIMGUI_API ImGuiSettingsHandler*
  ImGuiSettingsHandler_ImGuiSettingsHandler(void);
CIMGUI_API void
  ImGuiSettingsHandler_destroy(ImGuiSettingsHandler* self);
CIMGUI_API ImGuiDebugAllocInfo*
  ImGuiDebugAllocInfo_ImGuiDebugAllocInfo(void);
CIMGUI_API void
  ImGuiDebugAllocInfo_destroy(ImGuiDebugAllocInfo* self);
CIMGUI_API ImGuiStackLevelInfo*
  ImGuiStackLevelInfo_ImGuiStackLevelInfo(void);
CIMGUI_API void
  ImGuiStackLevelInfo_destroy(ImGuiStackLevelInfo* self);
CIMGUI_API ImGuiDebugItemPathQuery*
  ImGuiDebugItemPathQuery_ImGuiDebugItemPathQuery(void);
CIMGUI_API void
  ImGuiDebugItemPathQuery_destroy(ImGuiDebugItemPathQuery* self);
...
CIMGUI_API ImGuiWindow*
  ImGuiWindow_ImGuiWindow(ImGuiContext* context, const char* name);
CIMGUI_API void    ImGuiWindow_destroy(ImGuiWindow* self);
CIMGUI_API ImGuiID ImGuiWindow_GetID_Str(
  ImGuiWindow* self, const char* str, const char* str_end
);
CIMGUI_API ImGuiID
  ImGuiWindow_GetID_Ptr(ImGuiWindow* self, const void* ptr);
CIMGUI_API ImGuiID ImGuiWindow_GetID_Int(ImGuiWindow* self, int n);
CIMGUI_API ImGuiID
  ImGuiWindow_GetIDFromPos(ImGuiWindow* self, const ImVec2_c p_abs);
CIMGUI_API ImGuiID ImGuiWindow_GetIDFromRectangle(
  ImGuiWindow* self, const ImRect_c r_abs
);
...
CIMGUI_API ImGuiTableTempData*
                ImGuiTableTempData_ImGuiTableTempData(void);
...
CIMGUI_API ImGuiTableSettings*
                ImGuiTableSettings_ImGuiTableSettings(void);
...
CIMGUI_API ImGuiPlatformIO*
                        igGetPlatformIO_ContextPtr(ImGuiContext* ctx);
...
CIMGUI_API void igSetWindowPos_WindowPtr(
  ImGuiWindow* window, const ImVec2_c pos, ImGuiCond cond
);
CIMGUI_API void igSetWindowSize_WindowPtr(
  ImGuiWindow* window, const ImVec2_c size, ImGuiCond cond
);
...
CIMGUI_API void igSetWindowHitTestHole(
  ImGuiWindow* window, const ImVec2_c pos, const ImVec2_c size
);
CIMGUI_API void
  igSetWindowHiddenAndSkipItemsForCurrentFrame(ImGuiWindow* window);
CIMGUI_API void igSetWindowParentWindowForFocusRoute(
  ImGuiWindow* window, ImGuiWindow* parent_window
);
CIMGUI_API ImRect_c
  igWindowRectAbsToRel(ImGuiWindow* window, const ImRect_c r);
CIMGUI_API ImRect_c
  igWindowRectRelToAbs(ImGuiWindow* window, const ImRect_c r);
CIMGUI_API ImVec2_c
  igWindowPosAbsToRel(ImGuiWindow* window, const ImVec2_c p);
CIMGUI_API ImVec2_c
  igWindowPosRelToAbs(ImGuiWindow* window, const ImVec2_c p);
CIMGUI_API void
  igFocusWindow(ImGuiWindow* window, ImGuiFocusRequestFlags flags);
...
CIMGUI_API void
  igSetNextWindowRefreshPolicy(ImGuiWindowRefreshFlags flags);
...
CIMGUI_API void igSetCurrentFont(
  ImFont* font, float font_size_before_scaling,
  float font_size_after_scaling
);
CIMGUI_API void
  igUpdateCurrentFontSize(float restore_font_size_after_scaling);
...
CIMGUI_API ImDrawList*
  igGetForegroundDrawList_WindowPtr(ImGuiWindow* window);
CIMGUI_API void igAddDrawListToDrawDataEx(
  ImDrawData* draw_data, ImVector_ImDrawListPtr* out_list,
...
CIMGUI_API ImGuiID
  igAddContextHook(ImGuiContext* ctx, const ImGuiContextHook* hook);
CIMGUI_API void
  igRemoveContextHook(ImGuiContext* ctx, ImGuiID hook_to_remove);
CIMGUI_API void
  igCallContextHooks(ImGuiContext* ctx, ImGuiContextHookType type);
CIMGUI_API void igUpdateInputEvents(bool trickle_fast_inputs);
CIMGUI_API void
  igUpdateHoveredWindowAndCaptureFlags(const ImVec2_c mouse_pos);
CIMGUI_API void igFindHoveredWindowEx(
  const ImVec2_c pos, bool find_first_and_in_any_viewport,
...
CIMGUI_API void igStartMouseMovingWindowOrNode(
  ImGuiWindow* window, ImGuiDockNode* node, bool undock
);
...
CIMGUI_API void igTranslateWindowsInViewport(
  ImGuiViewportP* viewport, const ImVec2_c old_pos,
  const ImVec2_c new_pos, const ImVec2_c old_size,
  const ImVec2_c new_size
);
CIMGUI_API void
  igScaleWindowsInViewport(ImGuiViewportP* viewport, float scale);
CIMGUI_API void igDestroyPlatformWindow(ImGuiViewportP* viewport);
CIMGUI_API void
  igSetWindowViewport(ImGuiWindow* window, ImGuiViewportP* viewport);
CIMGUI_API void
  igSetCurrentViewport(ImGuiWindow* window, ImGuiViewportP* viewport);
CIMGUI_API const ImGuiPlatformMonitor*
  igGetViewportPlatformMonitor(ImGuiViewport* viewport);
CIMGUI_API ImGuiViewportP*
...
CIMGUI_API void
  igAddSettingsHandler(const ImGuiSettingsHandler* handler);
CIMGUI_API void igRemoveSettingsHandler(const char* type_name);
CIMGUI_API ImGuiSettingsHandler*
  igFindSettingsHandler(const char* type_name);
CIMGUI_API ImGuiWindowSettings*
  igCreateNewWindowSettings(const char* name);
...
CIMGUI_API void
  igLocalizeRegisterEntries(const ImGuiLocEntry* entries, int count);
CIMGUI_API const char* igLocalizeGetMsg(ImGuiLocKey key);
CIMGUI_API void
  igSetScrollX_WindowPtr(ImGuiWindow* window, float scroll_x);
CIMGUI_API void
  igSetScrollY_WindowPtr(ImGuiWindow* window, float scroll_y);
...
CIMGUI_API void igScrollToRect(
  ImGuiWindow* window, const ImRect_c rect, ImGuiScrollFlags flags
);
CIMGUI_API ImVec2_c igScrollToRectEx(
  ImGuiWindow* window, const ImRect_c rect, ImGuiScrollFlags flags
);
CIMGUI_API void igScrollToBringRectIntoView(
  ImGuiWindow* window, const ImRect_c rect
);
...
CIMGUI_API void
  igItemSize_Vec2(const ImVec2_c size, float text_baseline_y);
CIMGUI_API void
  igItemSize_Rect(const ImRect_c bb, float text_baseline_y);
CIMGUI_API bool igItemAdd(
  const ImRect_c bb, ImGuiID id, const ImRect* nav_bb,
  ImGuiItemFlags extra_flags
);
CIMGUI_API bool igItemHoverable(
  const ImRect_c bb, ImGuiID id, ImGuiItemFlags item_flags
);
...
CIMGUI_API void igSetLastItemData(
  ImGuiID item_id, ImGuiItemFlags item_flags,
  ImGuiItemStatusFlags status_flags, const ImRect_c item_rect
);
CIMGUI_API ImVec2_c
  igCalcItemSize(ImVec2_c size, float default_w, float default_h);
CIMGUI_API float
  igCalcWrapWidthForPos(const ImVec2_c pos, float wrap_pos_x);
CIMGUI_API void
  igPushMultiItemsWidths(int components, float width_full);
CIMGUI_API void igShrinkWidths(
  ImGuiShrinkWidthItem* items, int count, float width_excess,
  float width_min
);
CIMGUI_API void igCalcClipRectVisibleItemsY(
  const ImRect_c clip_rect, const ImVec2_c pos, float items_height,
  int* out_visible_start, int* out_visible_end
);
CIMGUI_API const ImGuiStyleVarInfo*
                igGetStyleVarInfo(ImGuiStyleVar idx);
...
CIMGUI_API void igLogRenderedText(
  const ImVec2_c* ref_pos, const char* text, const char* text_end
);
CIMGUI_API void
  igLogSetNextTextDecoration(const char* prefix, const char* suffix);
CIMGUI_API bool igBeginChildEx(
  const char* name, ImGuiID id, const ImVec2_c size_arg,
  ImGuiChildFlags child_flags, ImGuiWindowFlags window_flags
);
CIMGUI_API bool
  igBeginPopupEx(ImGuiID id, ImGuiWindowFlags extra_window_flags);
CIMGUI_API bool igBeginPopupMenuEx(
  ImGuiID id, const char* label, ImGuiWindowFlags extra_window_flags
);
CIMGUI_API void
  igOpenPopupEx(ImGuiID id, ImGuiPopupFlags popup_flags);
...
CIMGUI_API bool
  igIsPopupOpen_ID(ImGuiID id, ImGuiPopupFlags popup_flags);
...
CIMGUI_API ImVec2_c igFindBestWindowPosForPopupEx(
  const ImVec2_c ref_pos, const ImVec2_c size, ImGuiDir* last_dir,
  const ImRect_c r_outer, const ImRect_c r_avoid,
  ImGuiPopupPositionPolicy policy
);
CIMGUI_API ImGuiMouseButton
  igGetMouseButtonFromPopupFlags(ImGuiPopupFlags flags);
CIMGUI_API bool
  igIsPopupOpenRequestForItem(ImGuiPopupFlags flags, ImGuiID id);
...
CIMGUI_API void
  igNavMoveRequestResolveWithLastItem(ImGuiNavItemData* result);
...
CIMGUI_API ImGuiKeyData*
  igGetKeyData_ContextPtr(ImGuiContext* ctx, ImGuiKey key);
...
CIMGUI_API ImVec2_c igGetKeyMagnitude2d(
  ImGuiKey key_left, ImGuiKey key_right, ImGuiKey key_up,
  ImGuiKey key_down
);
...
CIMGUI_API void    igSetKeyOwner(
     ImGuiKey key, ImGuiID owner_id, ImGuiInputFlags flags
   );
CIMGUI_API void igSetKeyOwnersForKeyChord(
  ImGuiKeyChord key, ImGuiID owner_id, ImGuiInputFlags flags
);
CIMGUI_API void
  igSetItemKeyOwner_InputFlags(ImGuiKey key, ImGuiInputFlags flags);
CIMGUI_API bool igTestKeyOwner(ImGuiKey key, ImGuiID owner_id);
CIMGUI_API ImGuiKeyOwnerData*
                igGetKeyOwnerData(ImGuiContext* ctx, ImGuiKey key);
CIMGUI_API bool igIsKeyDown_ID(ImGuiKey key, ImGuiID owner_id);
CIMGUI_API bool igIsKeyPressed_InputFlags(
  ImGuiKey key, ImGuiInputFlags flags, ImGuiID owner_id
);
CIMGUI_API bool igIsKeyReleased_ID(ImGuiKey key, ImGuiID owner_id);
CIMGUI_API bool igIsKeyChordPressed_InputFlags(
  ImGuiKeyChord key_chord, ImGuiInputFlags flags, ImGuiID owner_id
);
CIMGUI_API bool
  igIsMouseDown_ID(ImGuiMouseButton button, ImGuiID owner_id);
CIMGUI_API bool igIsMouseClicked_InputFlags(
  ImGuiMouseButton button, ImGuiInputFlags flags, ImGuiID owner_id
);
CIMGUI_API bool
  igIsMouseReleased_ID(ImGuiMouseButton button, ImGuiID owner_id);
CIMGUI_API bool igIsMouseDoubleClicked_ID(
  ImGuiMouseButton button, ImGuiID owner_id
);
CIMGUI_API bool igShortcut_ID(
  ImGuiKeyChord key_chord, ImGuiInputFlags flags, ImGuiID owner_id
);
...
CIMGUI_API bool
  igTestShortcutRouting(ImGuiKeyChord key_chord, ImGuiID owner_id);
CIMGUI_API ImGuiKeyRoutingData*
...
CIMGUI_API void
  igDockContextNewFrameUpdateUndocking(ImGuiContext* ctx);
...
CIMGUI_API void igDockContextQueueUndockWindow(
  ImGuiContext* ctx, ImGuiWindow* window
);
CIMGUI_API void igDockContextQueueUndockNode(
...
CIMGUI_API void igDockContextProcessUndockNode(
  ImGuiContext* ctx, ImGuiDockNode* node
);
CIMGUI_API bool igDockContextCalcDropPosForDocking(
  ...
  ImGuiDir split_dir, bool split_outer, ImVec2_c* out_pos
);
CIMGUI_API ImGuiDockNode*
  igDockContextFindNodeByID(ImGuiContext* ctx, ImGuiID id);
CIMGUI_API void igDockNodeWindowMenuHandler_Default(
  ImGuiContext* ctx, ImGuiDockNode* node, ImGuiTabBar* tab_bar
);
...
CIMGUI_API bool           igDockNodeIsInHierarchyOf(
            ImGuiDockNode* node, ImGuiDockNode* parent
          );
CIMGUI_API int igDockNodeGetDepth(const ImGuiDockNode* node);
CIMGUI_API ImGuiID
  igDockNodeGetWindowMenuButtonId(const ImGuiDockNode* node);
...
CIMGUI_API void igSetWindowDock(
  ImGuiWindow* window, ImGuiID dock_id, ImGuiCond cond
);
CIMGUI_API void
  igDockBuilderDockWindow(const char* window_name, ImGuiID node_id);
CIMGUI_API ImGuiDockNode* igDockBuilderGetNode(ImGuiID node_id);
CIMGUI_API ImGuiDockNode*
  igDockBuilderGetCentralNode(ImGuiID node_id);
CIMGUI_API ImGuiID
  igDockBuilderAddNode(ImGuiID node_id, ImGuiDockNodeFlags flags);
CIMGUI_API void igDockBuilderRemoveNode(ImGuiID node_id);
CIMGUI_API void igDockBuilderRemoveNodeDockedWindows(
  ImGuiID node_id, bool clear_settings_refs
);
CIMGUI_API void igDockBuilderRemoveNodeChildNodes(ImGuiID node_id);
CIMGUI_API void
  igDockBuilderSetNodePos(ImGuiID node_id, ImVec2_c pos);
CIMGUI_API void
  igDockBuilderSetNodeSize(ImGuiID node_id, ImVec2_c size);
CIMGUI_API ImGuiID igDockBuilderSplitNode(
  ImGuiID node_id, ImGuiDir split_dir,
...
CIMGUI_API void igDockBuilderCopyNode(
  ImGuiID src_node_id, ImGuiID dst_node_id,
  ImVector_ImGuiID* out_node_remap_pairs
);
CIMGUI_API void igDockBuilderCopyWindowSettings(
...
CIMGUI_API bool
  igBeginDragDropTargetCustom(const ImRect_c bb, ImGuiID id);
CIMGUI_API bool igBeginDragDropTargetViewport(
  ImGuiViewport* viewport, const ImRect* p_bb
);
...
CIMGUI_API void igRenderDragDropTargetRectEx(
  ImDrawList* draw_list, const ImRect_c bb
);
CIMGUI_API ImGuiTypingSelectRequest*
               igGetTypingSelectRequest(ImGuiTypingSelectFlags flags);
...
CIMGUI_API bool igBeginBoxSelect(
  const ImRect_c scope_rect, ImGuiWindow* window,
  ImGuiID box_select_id, ImGuiMultiSelectFlags ms_flags
);
CIMGUI_API void igEndBoxSelect(
  const ImRect_c scope_rect, ImGuiMultiSelectFlags ms_flags
);
CIMGUI_API void igMultiSelectItemHeader(
  ImGuiID id, bool* p_selected, ImGuiButtonFlags* p_button_flags
);
CIMGUI_API void igMultiSelectItemFooter(
  ImGuiID id, bool* p_selected, bool* p_pressed
);
CIMGUI_API void
  igMultiSelectAddSetAll(ImGuiMultiSelectTempData* ms, bool selected);
CIMGUI_API void igMultiSelectAddSetRange(
  ImGuiMultiSelectTempData* ms, bool selected, int range_dir,
...
CIMGUI_API void                   igSetWindowClipRectBeforeSetChannel(
                    ImGuiWindow* window, const ImRect_c clip_rect
                  );
CIMGUI_API void igBeginColumns(
  const char* str_id, int count, ImGuiOldColumnFlags flags
);
...
CIMGUI_API ImGuiOldColumns*
  igFindOrCreateColumns(ImGuiWindow* window, ImGuiID id);
...
CIMGUI_API bool        igBeginTableEx(
         ...
         ImGuiTableFlags flags, const ImVec2_c outer_size, float inner_width
       );
CIMGUI_API void
  igTableBeginInitMemory(ImGuiTable* table, int columns_count);
...
CIMGUI_API void
  igTableUpdateColumnsWeightFromWidth(ImGuiTable* table);
...
CIMGUI_API ImGuiTableInstanceData*
  igTableGetInstanceData(ImGuiTable* table, int instance_no);
CIMGUI_API ImGuiID
  igTableGetInstanceID(ImGuiTable* table, int instance_no);
...
CIMGUI_API ImRect_c
  igTableGetCellBgRect(const ImGuiTable* table, int column_n);
CIMGUI_API const char* igTableGetColumnName_TablePtr(
  const ImGuiTable* table, int column_n
);
CIMGUI_API ImGuiID igTableGetColumnResizeID(
  ImGuiTable* table, int column_n, int instance_no
);
CIMGUI_API float
  igTableCalcMaxColumnWidth(const ImGuiTable* table, int column_n);
CIMGUI_API void
  igTableSetColumnWidthAutoSingle(ImGuiTable* table, int column_n);
CIMGUI_API void igTableSetColumnWidthAutoAll(ImGuiTable* table);
CIMGUI_API void igTableSetColumnDisplayOrder(
  ImGuiTable* table, int column_n, int dst_order
);
CIMGUI_API void igTableQueueSetColumnDisplayOrder(
  ImGuiTable* table, int column_n, int dst_order
);
CIMGUI_API void igTableRemove(ImGuiTable* table);
CIMGUI_API void
  igTableGcCompactTransientBuffers_TablePtr(ImGuiTable* table);
...
CIMGUI_API ImGuiTableSettings*
                igTableGetBoundSettings(ImGuiTable* table);
CIMGUI_API void igTableSettingsAddSettingsHandler(void);
CIMGUI_API ImGuiTableSettings*
  igTableSettingsCreate(ImGuiID id, int columns_count);
...
CIMGUI_API bool                igBeginTabBarEx(
                 ImGuiTabBar* tab_bar, const ImRect_c bb, ImGuiTabBarFlags flags
               );
CIMGUI_API ImGuiTabItem*
  igTabBarFindTabByID(ImGuiTabBar* tab_bar, ImGuiID tab_id);
CIMGUI_API ImGuiTabItem*
  igTabBarFindTabByOrder(ImGuiTabBar* tab_bar, int order);
CIMGUI_API ImGuiTabItem*
...
CIMGUI_API int
  igTabBarGetTabOrder(ImGuiTabBar* tab_bar, ImGuiTabItem* tab);
CIMGUI_API const char*
  igTabBarGetTabName(ImGuiTabBar* tab_bar, ImGuiTabItem* tab);
CIMGUI_API void igTabBarAddTab(
  ImGuiTabBar* tab_bar, ImGuiTabItemFlags tab_flags,
  ImGuiWindow* window
);
CIMGUI_API void
  igTabBarRemoveTab(ImGuiTabBar* tab_bar, ImGuiID tab_id);
CIMGUI_API void
  igTabBarCloseTab(ImGuiTabBar* tab_bar, ImGuiTabItem* tab);
CIMGUI_API void igTabBarQueueFocus_TabItemPtr(
  ImGuiTabBar* tab_bar, ImGuiTabItem* tab
);
CIMGUI_API void
  igTabBarQueueFocus_Str(ImGuiTabBar* tab_bar, const char* tab_name);
CIMGUI_API void igTabBarQueueReorder(
  ImGuiTabBar* tab_bar, ImGuiTabItem* tab, int offset
);
CIMGUI_API void igTabBarQueueReorderFromMousePos(
  ImGuiTabBar* tab_bar, ImGuiTabItem* tab, ImVec2_c mouse_pos
);
...
CIMGUI_API void igTabItemSpacing(
  const char* str_id, ImGuiTabItemFlags flags, float width
);
CIMGUI_API ImVec2_c igTabItemCalcSize_Str(
  const char* label, bool has_close_button_or_unsaved_marker
);
CIMGUI_API ImVec2_c igTabItemCalcSize_WindowPtr(ImGuiWindow* window);
CIMGUI_API void     igTabItemBackground(
      ImDrawList* draw_list, const ImRect_c bb, ImGuiTabItemFlags flags,
      ImU32 col
    );
CIMGUI_API void igTabItemLabelAndCloseButton(
  ImDrawList* draw_list, const ImRect_c bb, ImGuiTabItemFlags flags,
  ImVec2_c frame_padding, const char* label, ImGuiID tab_id,
  ImGuiID close_button_id, bool is_contents_visible,
  bool* out_just_closed, bool* out_text_clipped
);
CIMGUI_API void igRenderText(
  ImVec2_c pos, const char* text, const char* text_end,
...
CIMGUI_API void igRenderTextClipped(
  const ImVec2_c pos_min, const ImVec2_c pos_max, const char* text,
  const char* text_end, const ImVec2_c* text_size_if_known,
  const ImVec2_c align, const ImRect* clip_rect
);
CIMGUI_API void igRenderTextClippedEx(
  ImDrawList* draw_list, const ImVec2_c pos_min,
  const ImVec2_c pos_max, const char* text, const char* text_end,
  const ImVec2_c* text_size_if_known, const ImVec2_c align,
  const ImRect* clip_rect
);
CIMGUI_API void igRenderTextEllipsis(
  ImDrawList* draw_list, const ImVec2_c pos_min,
  const ImVec2_c pos_max, float ellipsis_max_x, const char* text,
  const char* text_end, const ImVec2_c* text_size_if_known
);
CIMGUI_API void igRenderFrame(
  ImVec2_c p_min, ImVec2_c p_max, ImU32 fill_col, bool borders,
  float rounding
);
CIMGUI_API void
  igRenderFrameBorder(ImVec2_c p_min, ImVec2_c p_max, float rounding);
CIMGUI_API void igRenderColorComponentMarker(
  const ImRect_c bb, ImU32 col, float rounding
);
CIMGUI_API void igRenderColorRectWithAlphaCheckerboard(
  ImDrawList* draw_list, ImVec2_c p_min, ImVec2_c p_max,
  ImU32 fill_col, float grid_step, ImVec2_c grid_off, float rounding,
  ImDrawFlags flags
);
CIMGUI_API void igRenderNavCursor(
  const ImRect_c bb, ImGuiID id, ImGuiNavRenderCursorFlags flags
);
CIMGUI_API const char*
  igFindRenderedTextEnd(const char* text, const char* text_end);
CIMGUI_API void igRenderMouseCursor(
  ImVec2_c pos, float scale, ImGuiMouseCursor mouse_cursor,
  ImU32 col_fill, ImU32 col_border, ImU32 col_shadow
);
CIMGUI_API void igRenderArrow(
  ImDrawList* draw_list, ImVec2_c pos, ImU32 col, ImGuiDir dir,
  float scale
);
CIMGUI_API void
  igRenderBullet(ImDrawList* draw_list, ImVec2_c pos, ImU32 col);
CIMGUI_API void igRenderCheckMark(
  ImDrawList* draw_list, ImVec2_c pos, ImU32 col, float sz
);
CIMGUI_API void igRenderArrowPointingAt(
  ImDrawList* draw_list, ImVec2_c pos, ImVec2_c half_sz,
  ImGuiDir direction, ImU32 col
);
CIMGUI_API void igRenderArrowDockMenu(
  ImDrawList* draw_list, ImVec2_c p_min, float sz, ImU32 col
);
CIMGUI_API void igRenderRectFilledInRangeH(
  ImDrawList* draw_list, const ImRect_c rect, ImU32 col,
  float fill_x0, float fill_x1, float rounding
);
CIMGUI_API void igRenderRectFilledWithHole(
  ImDrawList* draw_list, const ImRect_c outer, const ImRect_c inner,
  ImU32 col, float rounding
);
CIMGUI_API ImDrawFlags igCalcRoundingFlagsForRectInRect(
  const ImRect_c r_in, const ImRect_c r_outer, float threshold
);
CIMGUI_API void igTextEx(
  const char* text, const char* text_end, ImGuiTextFlags flags
);
CIMGUI_API void
  igTextAligned(float align_x, float size_x, const char* fmt, ...);
#ifdef CIMGUI_VARGS0
CIMGUI_API void
  igTextAligned0(float align_x, float size_x, const char* fmt);
#endif
CIMGUI_API void igTextAlignedV(
  float align_x, float size_x, const char* fmt, va_list args
);
CIMGUI_API bool igButtonEx(
  const char* label, const ImVec2_c size_arg, ImGuiButtonFlags flags
);
CIMGUI_API bool igArrowButtonEx(
  const char* str_id, ImGuiDir dir, ImVec2_c size_arg,
  ImGuiButtonFlags flags
);
CIMGUI_API bool igImageButtonEx(
  ImGuiID id, ImTextureRef_c tex_ref, const ImVec2_c image_size,
  const ImVec2_c uv0, const ImVec2_c uv1, const ImVec4_c bg_col,
  const ImVec4_c tint_col, ImGuiButtonFlags flags
);
CIMGUI_API void
  igSeparatorEx(ImGuiSeparatorFlags flags, float thickness);
CIMGUI_API void igSeparatorTextEx(
  ImGuiID id, const char* label, const char* label_end,
  float extra_width
);
...
CIMGUI_API bool igCollapseButton(
  ImGuiID id, const ImVec2_c pos, ImGuiDockNode* dock_node
);
CIMGUI_API void igScrollbar(ImGuiAxis axis);
CIMGUI_API bool igScrollbarEx(
  const ImRect_c bb, ImGuiID id, ImGuiAxis axis, ImS64* p_scroll_v,
  ImS64 avail_v, ImS64 contents_v, ImDrawFlags draw_rounding_flags
);
CIMGUI_API ImRect_c
  igGetWindowScrollbarRect(ImGuiWindow* window, ImGuiAxis axis);
CIMGUI_API ImGuiID
  igGetWindowScrollbarID(ImGuiWindow* window, ImGuiAxis axis);
CIMGUI_API ImGuiID
  igGetWindowResizeCornerID(ImGuiWindow* window, int n);
CIMGUI_API ImGuiID
  igGetWindowResizeBorderID(ImGuiWindow* window, ImGuiDir dir);
CIMGUI_API void igExtendHitBoxWhenNearViewportEdge(
  ImGuiWindow* window, ImRect* bb, float threshold, ImGuiAxis axis
);
CIMGUI_API bool igButtonBehavior(
  const ImRect_c bb, ImGuiID id, bool* out_hovered, bool* out_held,
  ImGuiButtonFlags flags
);
CIMGUI_API bool igDragBehavior(
  ImGuiID id, ImGuiDataType data_type, void* p_v, float v_speed,
  const void* p_min, const void* p_max, const char* format,
  ImGuiSliderFlags flags
);
CIMGUI_API bool igSliderBehavior(
  const ImRect_c bb, ImGuiID id, ImGuiDataType data_type, void* p_v,
  const void* p_min, const void* p_max, const char* format,
  ImGuiSliderFlags flags, ImRect* out_grab_bb
);
CIMGUI_API bool igSplitterBehavior(
  const ImRect_c bb, ImGuiID id, ImGuiAxis axis, float* size1,
...
CIMGUI_API void
  igTreeNodeDrawLineToChildNode(const ImVec2_c target_pos);
CIMGUI_API void
  igTreeNodeDrawLineToTreePop(const ImGuiTreeNodeStackData* data);
CIMGUI_API void igTreePushOverrideID(ImGuiID id);
CIMGUI_API void igTreeNodeSetOpen(ImGuiID storage_id, bool open);
CIMGUI_API bool igTreeNodeUpdateNextOpen(
  ImGuiID storage_id, ImGuiTreeNodeFlags flags
);
CIMGUI_API const ImGuiDataTypeInfo*
               igDataTypeGetInfo(ImGuiDataType data_type);
CIMGUI_API int igDataTypeFormatString(
  char* buf, int buf_size, ImGuiDataType data_type,
...
CIMGUI_API bool igDataTypeApplyFromText(
  const char* buf, ImGuiDataType data_type, void* p_data,
...
CIMGUI_API void
  igSetNextItemRefVal(ImGuiDataType data_type, void* p_data);
...
CIMGUI_API void
  igErrorCheckUsingSetCursorPosToExtendParentBoundaries(void);
...
CIMGUI_API void
  igDemoMarker(const char* file, int line, const char* section);
CIMGUI_API void igDebugAllocHook(
...
CIMGUI_API void igDebugTextUnformattedWithLocateItem(
...
CIMGUI_API bool igDebugBreakButton(
  const char* label, const char* description_of_location
);
CIMGUI_API void igDebugBreakButtonTooltip(
  bool keyboard_only, const char* description_of_location
);
...
CIMGUI_API void  igDebugHookIdInfo(
   ImGuiID id, ImGuiDataType data_type, const void* data_id,
   const void* data_id_end
 );
CIMGUI_API void igDebugNodeColumns(ImGuiOldColumns* columns);
CIMGUI_API void
  igDebugNodeDockNode(ImGuiDockNode* node, const char* label);
...
CIMGUI_API void igDebugNodeFontGlyphsForSrcMask(
  ImFont* font, ImFontBaked* baked, int src_mask
);
CIMGUI_API void
  igDebugNodeFontGlyph(ImFont* font, const ImFontGlyph* glyph);
CIMGUI_API void igDebugNodeTexture(
  ImTextureData* tex, int int_id,
  const ImFontAtlasRect* highlight_rect
);
CIMGUI_API void
  igDebugNodeStorage(ImGuiStorage* storage, const char* label);
CIMGUI_API void
  igDebugNodeTabBar(ImGuiTabBar* tab_bar, const char* label);
CIMGUI_API void igDebugNodeTable(ImGuiTable* table);
CIMGUI_API void
  igDebugNodeTableSettings(ImGuiTableSettings* settings);
CIMGUI_API void igDebugNodeInputTextState(ImGuiInputTextState* state);
CIMGUI_API void
  igDebugNodeTypingSelectState(ImGuiTypingSelectState* state);
CIMGUI_API void
  igDebugNodeMultiSelectState(ImGuiMultiSelectState* state);
CIMGUI_API void
  igDebugNodeWindow(ImGuiWindow* window, const char* label);
CIMGUI_API void
  igDebugNodeWindowSettings(ImGuiWindowSettings* settings);
CIMGUI_API void igDebugNodeWindowsList(
  ImVector_ImGuiWindowPtr* windows, const char* label
);
...
CIMGUI_API void igDebugNodePlatformMonitor(
  ImGuiPlatformMonitor* monitor, const char* label, int idx
);
CIMGUI_API void igDebugRenderKeyboardPreview(ImDrawList* draw_list);
CIMGUI_API void igDebugRenderViewportThumbnail(
  ImDrawList* draw_list, ImGuiViewportP* viewport, const ImRect_c bb
);
CIMGUI_API ImFontLoader* ImFontLoader_ImFontLoader(void);
CIMGUI_API void          ImFontLoader_destroy(ImFontLoader* self);
CIMGUI_API const ImFontLoader*
               igImFontAtlasGetFontLoaderForStbTruetype(void);
CIMGUI_API int igImFontAtlasRectId_GetIndex(ImFontAtlasRectId id);
CIMGUI_API unsigned int
  igImFontAtlasRectId_GetGeneration(ImFontAtlasRectId id);
CIMGUI_API ImFontAtlasRectId
  igImFontAtlasRectId_Make(int index_idx, int gen_idx);
CIMGUI_API ImFontAtlasBuilder*
                ImFontAtlasBuilder_ImFontAtlasBuilder(void);
...
CIMGUI_API void igImFontAtlasBuildSetupFontLoader(
  ImFontAtlas* atlas, const ImFontLoader* font_loader
);
CIMGUI_API void igImFontAtlasBuildNotifySetFont(
...
CIMGUI_API ImTextureData*
  igImFontAtlasTextureAdd(ImFontAtlas* atlas, int w, int h);
CIMGUI_API void igImFontAtlasTextureMakeSpace(ImFontAtlas* atlas);
CIMGUI_API void
  igImFontAtlasTextureRepack(ImFontAtlas* atlas, int w, int h);
CIMGUI_API void
  igImFontAtlasTextureGrow(ImFontAtlas* atlas, int old_w, int old_h);
CIMGUI_API void igImFontAtlasTextureCompact(ImFontAtlas* atlas);
CIMGUI_API ImVec2i_c
  igImFontAtlasTextureGetSizeEstimate(ImFontAtlas* atlas);
CIMGUI_API void igImFontAtlasBuildSetupFontSpecialGlyphs(
  ImFontAtlas* atlas, ImFont* font, ImFontConfig* src
);
CIMGUI_API void
  igImFontAtlasBuildLegacyPreloadAllGlyphRanges(ImFontAtlas* atlas);
CIMGUI_API void igImFontAtlasBuildGetOversampleFactors(
  ImFontConfig* src, ImFontBaked* baked, int* out_oversample_h,
  int* out_oversample_v
);
CIMGUI_API void igImFontAtlasBuildDiscardBakes(
  ImFontAtlas* atlas, int unused_frames
);
CIMGUI_API bool
  igImFontAtlasFontSourceInit(ImFontAtlas* atlas, ImFontConfig* src);
CIMGUI_API void igImFontAtlasFontSourceAddToFont(
  ImFontAtlas* atlas, ImFont* font, ImFontConfig* src
);
CIMGUI_API void igImFontAtlasFontDestroySourceData(
  ImFontAtlas* atlas, ImFontConfig* src
);
CIMGUI_API bool
  igImFontAtlasFontInitOutput(ImFontAtlas* atlas, ImFont* font);
CIMGUI_API void
  igImFontAtlasFontDestroyOutput(ImFontAtlas* atlas, ImFont* font);
CIMGUI_API void
  igImFontAtlasFontRebuildOutput(ImFontAtlas* atlas, ImFont* font);
CIMGUI_API void igImFontAtlasFontDiscardBakes(
  ImFontAtlas* atlas, ImFont* font, int unused_frames
);
CIMGUI_API ImGuiID igImFontAtlasBakedGetId(
  ImGuiID font_id, float baked_size, float rasterizer_density
);
CIMGUI_API ImFontBaked* igImFontAtlasBakedGetOrAdd(
  ImFontAtlas* atlas, ImFont* font, float font_size,
  float font_rasterizer_density
);
CIMGUI_API ImFontBaked* igImFontAtlasBakedGetClosestMatch(
  ImFontAtlas* atlas, ImFont* font, float font_size,
  float font_rasterizer_density
);
CIMGUI_API ImFontBaked* igImFontAtlasBakedAdd(
  ImFontAtlas* atlas, ImFont* font, float font_size,
  float font_rasterizer_density, ImGuiID baked_id
);
CIMGUI_API void igImFontAtlasBakedDiscard(
  ImFontAtlas* atlas, ImFont* font, ImFontBaked* baked
);
CIMGUI_API ImFontGlyph* igImFontAtlasBakedAddFontGlyph(
...
CIMGUI_API void igImFontAtlasBakedDiscardFontGlyph(
  ImFontAtlas* atlas, ImFont* font, ImFontBaked* baked,
  ImFontGlyph* glyph
);
CIMGUI_API void igImFontAtlasBakedSetFontGlyphBitmap(
  ImFontAtlas* atlas, ImFontBaked* baked, ImFontConfig* src,
...
CIMGUI_API ImFontAtlasRectId igImFontAtlasPackAddRect(
  ImFontAtlas* atlas, int w, int h,
  ImFontAtlasRectEntry* overwrite_entry
);
CIMGUI_API ImTextureRect*
  igImFontAtlasPackGetRect(ImFontAtlas* atlas, ImFontAtlasRectId id);
CIMGUI_API ImTextureRect* igImFontAtlasPackGetRectSafe(
  ImFontAtlas* atlas, ImFontAtlasRectId id
);
CIMGUI_API void igImFontAtlasPackDiscardRect(
  ImFontAtlas* atlas, ImFontAtlasRectId id
);
CIMGUI_API void igImFontAtlasUpdateNewFrame(
  ImFontAtlas* atlas, int frame_count, bool renderer_has_textures
);
CIMGUI_API void igImFontAtlasAddDrawListSharedData(
  ImFontAtlas* atlas, ImDrawListSharedData* data
);
CIMGUI_API void igImFontAtlasRemoveDrawListSharedData(
  ImFontAtlas* atlas, ImDrawListSharedData* data
);
CIMGUI_API void igImFontAtlasUpdateDrawListsTextures(
  ImFontAtlas* atlas, ImTextureRef_c old_tex, ImTextureRef_c new_tex
);
CIMGUI_API void
  igImFontAtlasUpdateDrawListsSharedData(ImFontAtlas* atlas);
CIMGUI_API void igImFontAtlasTextureBlockConvert(
  const unsigned char* src_pixels, ImTextureFormat src_fmt,
  int src_pitch, unsigned char* dst_pixels, ImTextureFormat dst_fmt,
  int dst_pitch, int w, int h
);
CIMGUI_API void igImFontAtlasTextureBlockPostProcess(
  ImFontAtlasPostProcessData* data
);
CIMGUI_API void igImFontAtlasTextureBlockPostProcessMultiply(
...
CIMGUI_API void igImFontAtlasTextureBlockCopy(
  ImTextureData* src_tex, int src_x, int src_y,
  ImTextureData* dst_tex, int dst_x, int dst_y, int w, int h
);
...
CIMGUI_API int
  igImTextureDataGetFormatBytesPerPixel(ImTextureFormat format);
CIMGUI_API const char*
  igImTextureDataGetStatusName(ImTextureStatus status);
CIMGUI_API const char*
  igImTextureDataGetFormatName(ImTextureFormat format);
CIMGUI_API void
  igImFontAtlasDebugLogTextureRequests(ImFontAtlas* atlas);
CIMGUI_API bool igImFontAtlasGetMouseCursorTexData(
  ImFontAtlas* atlas, ImGuiMouseCursor cursor_type,
  ImVec2_c* out_offset, ImVec2_c* out_size, ImVec2 out_uv_border[2],
