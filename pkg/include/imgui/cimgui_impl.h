...
CIMGUI_API void ImGui_ImplGlfw_CursorPosCallback(
...
CIMGUI_API bool ImGui_ImplGlfw_InitForOpenGL(
  GLFWwindow* window, bool install_callbacks
);
CIMGUI_API bool ImGui_ImplGlfw_InitForOther(
  GLFWwindow* window, bool install_callbacks
);
CIMGUI_API bool ImGui_ImplGlfw_InitForVulkan(
  GLFWwindow* window, bool install_callbacks
);
...
CIMGUI_API void ImGui_ImplGlfw_ScrollCallback(
  GLFWwindow* window, double xoffset, double yoffset
);
CIMGUI_API void ImGui_ImplGlfw_SetCallbacksChainForAllWindows(
...
CIMGUI_API void ImGui_ImplSDL2_SetMouseCaptureMode(
  ImGui_ImplSDL2_MouseCaptureMode mode
);
...
CIMGUI_API bool ImGui_ImplSDL3_InitForOpenGL(
  SDL_Window* window, void* sdl_gl_context
);
...
CIMGUI_API bool ImGui_ImplSDL3_InitForSDLRenderer(
  SDL_Window* window, SDL_Renderer* renderer
);
...
CIMGUI_API void ImGui_ImplSDL3_SetMouseCaptureMode(
  ImGui_ImplSDL3_MouseCaptureMode mode
);
...
typedef struct ImGui_ImplVulkan_PipelineInfo
...
typedef struct ImGui_ImplVulkan_RenderState
...
typedef ImVector<ImGui_ImplVulkanH_Frame>
  ImVector_ImGui_ImplVulkanH_Frame;
typedef ImVector<ImGui_ImplVulkanH_FrameSemaphores>
  ImVector_ImGui_ImplVulkanH_FrameSemaphores;
...
CIMGUI_API uint32_t ImGui_ImplVulkanH_SelectQueueFamilyIndex(
...
CIMGUI_API ImGui_ImplVulkanH_Window*
  ImGui_ImplVulkanH_Window_ImGui_ImplVulkanH_Window(void);
CIMGUI_API VkDescriptorSet ImGui_ImplVulkan_AddTexture(
  VkSampler sampler, VkImageView image_view,
  VkImageLayout image_layout
);
CIMGUI_API void ImGui_ImplVulkan_CreateMainPipeline(
